...
function ShopkeeperChangePassword(){
    ...
    const submitButtonHandler=()=>{
        if(validePassword&&valideConfirmPassword){
            ...
            ApiService.changeShopkeeperPassword(data).then((resp)=>{
        ...
        <div >
           <ShopkeeperNavBar/>
            <Grid container>
                ...
                <Button onClick={submitButtonHandler} style={{paddingLeft:"0px",marginLeft:"15%"}} variant="contained" color="primary">
                    Submit
                </Button>
                </Grid>
            </Grid>
...
export default ShopkeeperChangePassword;